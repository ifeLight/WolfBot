...
export default class Cobinhood extends CcxtExchange {
    constructor(options: ExOptions) {
        super(options);
        this.exchangeLabel = Currency.Exchange.COBINHOOD;
        this.minTradingValue = 0.001;
        this.fee = 0.0;
        this.currencies.setSwitchCurrencyPair(true);
        this.apiClient = new ccxt.cobinhood(this.getExchangeConfig());
