...
import WaveOpener from "./WaveOpener";
 ...
 */
export default class WaveOpenerLeverage extends WaveOpener implements IndexStrategy {
    //protected static readonly AROON_100 = 96;
    //protected static readonly AROON_LOW = 50;

    public action: WaveOpenerLeverageAction;
...
utils.objects.applyMixins(WaveOpenerLeverage, [IndexStrategy]);